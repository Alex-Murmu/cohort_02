...
export const LeftBar = () => {
    return <div className="bg-black w-48 hidden md:block pr-5">
      <BarWithIcon />
      <BarWithIcon />
      <BarWithIcon />
      <Line />
...
function BarElement({icon, title}: {icon: any; title: string;}) {
    return <div className="w-full rounded-xl bg-gray-950 hover:bg-gray-700 flex w-42 p-2 m-2 cursor-pointer">
        <div className="pr-2">
            {icon}
        </div>
        <div>
